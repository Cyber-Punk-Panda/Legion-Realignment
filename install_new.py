...
try:
    distutils.dir_util.remove_tree(os.path.join(root_folder + UI_SUFFIX))
except:
    print('No Old UI Folder')
print ('Copy Client')
shutil.copytree(os.path.join(root_folder, 'client'), os.path.join(root_folder + CLIENT_SUFFIX))
print ('Copy UI')
shutil.copytree(os.path.join(root_folder, 'branding'), os.path.join(root_folder + UI_SUFFIX))
print ('Copy Server')
...
print ('Merge Shared into UI')
distutils.dir_util.copy_tree(os.path.join(root_folder, 'shared'), os.path.join(root_folder + UI_SUFFIX))
